    ...
    useEffect(() => {
        const messageListener = (request, sender, sendResponse) => {
            if (request.action === "displayResults") {
                setAnalysisResults(request.results);
            }
        };
        ...
        <div className="m-2 flex justify-center text-center">
            ...
            {analysisResults && (
                <div className="mt-4">
                    ...
                    <div className="mt-2">
                        {Object.entries(analysisResults.categories).map(([category, details]) => (
                            details.confidence > 0.5 && (
                                <span
                                    key={category}
                                    className="bg-red-500 text-white px-2 py-1 rounded-md mr-2 mb-2 inline-block"
                                >
                                    {category} ({details.confidence.toFixed(2)})
                                    {details.explanation && (
...
const AuditLogo = () => {
    return (
        ...
        >
            ...
            <path d="M13 19L15 21L20 16" stroke="#ffffff"
